(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@angular/fire/storage', ['@angular/core','exports', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/fire', 'firebase/storage'], factory) :
    (global = global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.storage = {}), global.rxjs, global.rxjs.operators, global.ng.core, global.angular.fire));
}(this, (function (ɵngcc0,exports, rxjs, operators, i0, i1) { 'use strict';
...
AngularFireStorage.ɵfac = function AngularFireStorage_Factory(t) { return new (t || AngularFireStorage)(ɵngcc0.ɵɵinject(i1.FIREBASE_OPTIONS), ɵngcc0.ɵɵinject(i1.FIREBASE_APP_NAME, 8), ɵngcc0.ɵɵinject(BUCKET, 8), ɵngcc0.ɵɵinject(i0.PLATFORM_ID), ɵngcc0.ɵɵinject(ɵngcc0.NgZone)); };
