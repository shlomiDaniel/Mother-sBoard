(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/fire'), require('@angular/common'), require('@firebase/app'), require('@firebase/firestore'), require('firebase/firestore')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/firestore', ['@angular/core','exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/fire', '@angular/common', '@firebase/app', '@firebase/firestore', 'firebase/firestore'], factory) :
    (global = global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.firestore = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire, global.ng.common, global.firebase, global.firestore));
}(this, (function (ɵngcc0,exports, i0, rxjs, operators, i1, common, firebase, firestore) { 'use strict';
    ...
    var AngularFirestore = /** @class */ (function () {
        ...
        platformId, zone, persistenceSettings) {
             ...
             */function () {
                ...
                if (firestore.registerFirestore) {
...
AngularFirestore.ɵfac = function AngularFirestore_Factory(t) { return new (t || AngularFirestore)(ɵngcc0.ɵɵinject(i1.FIREBASE_OPTIONS), ɵngcc0.ɵɵinject(i1.FIREBASE_APP_NAME, 8), ɵngcc0.ɵɵinject(ENABLE_PERSISTENCE, 8), ɵngcc0.ɵɵinject(SETTINGS, 8), ɵngcc0.ɵɵinject(i0.PLATFORM_ID), ɵngcc0.ɵɵinject(ɵngcc0.NgZone), ɵngcc0.ɵɵinject(PERSISTENCE_SETTINGS, 8)); };
